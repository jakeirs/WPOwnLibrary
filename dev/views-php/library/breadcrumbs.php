...
echo '<ul id="' . $breadcrums_id . '" class="' . $breadcrums_class . '">';
    ...
    // Paginated archives
    echo '<li class="item-current item-current-' . get_query_var('paged') . '">'.__('Page', 'sequencesh') . ' ' . get_query_var('paged') . '</li>';

    } else if ( is_search() ) {

    // Search results page
    echo '<li class="item-current item-current-' . get_search_query() . '">Wyszukania dla: ' . get_search_query() . '</li>';
